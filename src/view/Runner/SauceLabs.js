	...
	*/
	showStart: function showStart() {
		...
		if (this.model.config.quit != 'always') {
			this.animator.log('⚠︎ ', 'info', 'You are using SauceLabs but are not quitting browsers immediately', 'warn');
			this.animator.log('  ', 'info', 'This setup wastes 90 seconds per failed test');
